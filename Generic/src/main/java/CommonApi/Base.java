...
public class Base {
    ...
    @BeforeMethod
    public void setUp(Boolean useCloudEnv,String userName, String key, String OS,String browser,  String browserVersion, String url) throws IOException {
        if(useCloudEnv == true){
            getCloudDriver(userName, key, OS, browser, browserVersion);
        }else{
            driver = getLocalDriver(OS,browser, browserVersion);
        }
    ...
    public WebDriver getLocalDriver(String OS,String browser, String browserVersion){
        if(browser.equalsIgnoreCase("firefox")){
            ...
            if(OS.equalsIgnoreCase("mac")){
                System.setProperty("webdriver.chrome.driver", "Generic/browser-drivers/chromedriver.exe");
            ...
            System.setProperty("webdriver.ie.driver", "Generic/browser-drivers/IEDriverServer.exe");
    ...
    public WebDriver getCloudDriver(String userName, String key, String OS, String browser, String browserVersion)throws IOException{
